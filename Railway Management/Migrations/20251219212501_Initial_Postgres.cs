        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    trainID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    trainNO = table.Column<string>(type: "text", nullable: false),
                    trainName = table.Column<string>(type: "text", nullable: false),
                    third_ac = table.Column<int>(type: "integer", nullable: true),
                    arrival_time = table.Column<TimeSpan>(type: "interval", nullable: true),
                    from_station_code = table.Column<string>(type: "text", nullable: false),
                    zone = table.Column<string>(type: "text", nullable: false),
                    chair_car = table.Column<int>(type: "integer", nullable: true),
                    first_class = table.Column<int>(type: "integer", nullable: true),
                    sleeper = table.Column<int>(type: "integer", nullable: true),
                    distance_cover = table.Column<int>(type: "integer", nullable: true),
                    departure_time = table.Column<TimeSpan>(type: "interval", nullable: true),
                    ...
                    seconndac = table.Column<int>(type: "integer", nullable: true),
                    tostationcode = table.Column<string>(type: "text", nullable: false),
                    returntrain = table.Column<string>(type: "text", nullable: false),
                    duration_hrs = table.Column<int>(type: "integer", nullable: true),
                    from_station_name = table.Column<string>(type: "text", nullable: false),
                    firstac = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Departure = table.Column<TimeSpan>(type: "interval", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BStationName = table.Column<string>(type: "text", nullable: false),
                    BStationCode = table.Column<string>(type: "text", nullable: false),
